...
<html>
    ...
    <body>
            ...
            <div class="content-header">
                ...
                <!-- Agregar esto como Título del Template -->
                    <font face="small fonts" size="10" color="#049286">
                        <h1 align="center" class="form-titulo" style ="margin-left: 5px; margin-top:20px; bg-success text-white"><g:message code="default.list" args="[entityName]" default="Listado de registros de ingreso"/></h1>
                    </font>
        ...
        <div id="list-registroIngreso" class="content scaffold-list" role="main">
            <h1><g:message code="default.list.label" args="[entityName]" /></h1>
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            <f:table collection="${registroIngresoList}" />

            <div class="pagination">
                <g:paginate total="${registroIngresoCount ?: 0}" />
            </div>
        </div>
    </body>
</html>