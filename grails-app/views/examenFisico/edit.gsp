    ...
    <body>
        ...
        <div id="edit-examenFisico" class="content scaffold-edit" role="main">
            ...
            <div style="text-align:center; margin: 0 auto;">
                <g:form resource="${this.examenFisico}" method="PUT">
                    <g:hiddenField name="version" value="${this.examenFisico?.version}" />
                    <fieldset class="form">
                        ...
                        <div class="fieldcontain ${hasErrors(bean: examenFisico.fechaRealizado, field: 'fechaRealizado', 'error')} ">
                            ...
                            <g:textField name="fechaRealizado" required="true" value="${this.examenFisico?.fechaRealizado}" class="form-control" style="width:35%; display:inline;" />
                        </div>
