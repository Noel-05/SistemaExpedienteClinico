...
<html>
    ...
    <body>
        ...
        <div id="show-indicacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="indicacion" />
            <g:form resource="${this.indicacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.indicacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
