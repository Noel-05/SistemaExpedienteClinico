...
<html>
	...
	<body>
		<div id="create-expediente" class="content scaffold-create" role="base">
			...
			<!-- Agregar esto como Título del Template -->
                <font face="small fonts" size="10" color="#049286">
                    <h1 align="center" class="form-titulo" style="margin-left: 5px; margin-top:20px; bg-success text-white"><g:message code="Crear nuevo expediente" args="[entityName]" /></h1>
                </font>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="col-md-9" style="margin-left: 100px;">
									<!--<div class="card-body">-->
									<div class="mt-4"></div>
									 <g:form resource="${this.expediente}" method="POST">
										<fieldset class="form">
											<div class="form-group row">
											<label for="fechaCreado" class="col-4 col-form-label"><strong>C&oacute;digo de Paciente:</strong> </label> 
											<div class="col-8">
											  <input id="idPersona" name="idPersona" placeholder="Elegir fecha de creación del expediente." type="text" required="required" class="form-control" value="${paciente}">
											...
											<div class="col-8">
											  <input id="fechaCreado" name="fechaCreado" placeholder="Elegir fecha de creación del expediente." type="date" required="required" class="form-control">
